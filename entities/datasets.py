...
from torch_geometric.datasets import Planetoid, PPI, Amazon, Reddit, Coauthor, SNAPDataset, PPI, TUDataset, AMiner, BitcoinOTC, CitationFull, DBP15K, Entities, Flickr, MoleculeNet, QM7b, WebKB, WikiCS, WordNet18, Yelp
